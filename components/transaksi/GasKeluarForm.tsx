...
type Props = { onGasKeluar: (jumlah: number, keterangan: string, tipe: TipeTabung) => void; };
      ...
      <div>
        ...
        <div className="flex gap-4 mt-2">
          <label className="inline-flex items-center gap-2">
            <input type="radio" name="tipe-keluar" checked={tipe === 'isi'} onChange={() => setTipe('isi')} />
            Tabung Isi
          </label>
          <label className="inline-flex items-center gap-2">
            <input type="radio" name="tipe-keluar" checked={tipe === 'kosong'} onChange={() => setTipe('kosong')} />
            Tabung Kosong
          </label>
        </div>
      </div>
